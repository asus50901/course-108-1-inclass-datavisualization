...
graphData <- read_csv("https://ws.moe.edu.tw/001/Upload/4/relfile/0/4764/a27e7193-392e-4780-9133-f27d3a65c791.csv", 
...
# add in the annotations for better understanding
...
# Change the color of 學制
avg.loan.freq

# college students tend to apply loan more often than high school students
  # perhaps the tuition is much higher in college

# highschool loans drop dramatically after year 98

# private highschool more loans while public college has more loans in college
